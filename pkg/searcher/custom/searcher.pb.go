...
const file_searcher_proto_rawDesc = "" +
	"\n" +
	"\x0esearcher.proto\x12\bsearcher\"\xda\x01\n" +
	...
	"\bcategory\x18\x05 \x01(\tH\x01R\bcategory\x88\x01\x01\x12\x1f\n" +
	"\blocation\x18\x06 \x01(\tH\x02R\blocation\x88\x01\x01B\b\n" +
	"\x06_limitB\v\n" +
	"\t_categoryB\v\n" +
	"\t_location\"<\n" +
