...
type ExtractorClient interface {
	Extract(ctx context.Context, in *ExtractRequest, opts ...grpc.CallOption) (*Document, error)
}
...
func (c *extractorClient) Extract(ctx context.Context, in *ExtractRequest, opts ...grpc.CallOption) (*Document, error) {
...
type ExtractorServer interface {
	Extract(context.Context, *ExtractRequest) (*Document, error)
...
func (UnimplementedExtractorServer) Extract(context.Context, *ExtractRequest) (*Document, error) {
