...
func (x *ToolResult) GetParts() []*Part {
	if x != nil {
		return x.Parts
	}
	return nil
...
const file_provider_proto_rawDesc = "" +
	...
	"\targuments\x18\x03 \x01(\tR\targuments\"Z\n" +
	"\x04Part\x12\x17\n" +
	"\x04text\x18\x01 \x01(\tH\x00R\x04text\x88\x01\x01\x12'\n" +
	"\x04file\x18\x02 \x01(\v2\x0e.provider.FileH\x01R\x04file\x88\x01\x01B\a\n" +
	"\x05_textB\a\n" +
	"\x05_file\"B\n" +
	"\n" +
	"ToolResult\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12$\n" +
	"\x05parts\x18\x02 \x03(\v2\x0e.provider.PartR\x05parts\"^\n" +
	"\x06Schema\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12 \n" +
	"\vdescription\x18\x02 \x01(\tR\vdescription\x12\x1e\n" +
	"\n" +
...
var file_provider_proto_goTypes = []any{
	...
	(*Part)(nil),            // 7: provider.Part
	(*ToolResult)(nil),      // 8: provider.ToolResult
	(*Schema)(nil),          // 9: provider.Schema
	(*Usage)(nil),           // 10: provider.Usage
	(*EmbedRequest)(nil),    // 11: provider.EmbedRequest
	(*Embeddings)(nil),      // 12: provider.Embeddings
	(*Embedding)(nil),       // 13: provider.Embedding
}
var file_provider_proto_depIdxs = []int32{
	...
	9,  // 2: provider.CompleteRequest.schema:type_name -> provider.Schema
	2,  // 3: provider.Completion.delta:type_name -> provider.Message
	2,  // 4: provider.Completion.message:type_name -> provider.Message
	10, // 5: provider.Completion.usage:type_name -> provider.Usage
	...
	8,  // 9: provider.Content.tool_result:type_name -> provider.ToolResult
	4,  // 10: provider.Part.file:type_name -> provider.File
	7,  // 11: provider.ToolResult.parts:type_name -> provider.Part
	13, // 12: provider.Embeddings.Embeddings:type_name -> provider.Embedding
	10, // 13: provider.Embeddings.usage:type_name -> provider.Usage
	0,  // 14: provider.Completer.Complete:input_type -> provider.CompleteRequest
	11, // 15: provider.Embedder.Embed:input_type -> provider.EmbedRequest
	1,  // 16: provider.Completer.Complete:output_type -> provider.Completion
	12, // 17: provider.Embedder.Embed:output_type -> provider.Embeddings
...
func file_provider_proto_init() {
	...
	file_provider_proto_msgTypes[7].OneofWrappers = []any{}
	file_provider_proto_msgTypes[12].OneofWrappers = []any{}
	type x struct{}
