...
type TranslatorClient interface {
	Translate(ctx context.Context, in *TranslateRequest, opts ...grpc.CallOption) (*TranslationResponse, error)
}
...
func (c *translatorClient) Translate(ctx context.Context, in *TranslateRequest, opts ...grpc.CallOption) (*TranslationResponse, error) {
...
type TranslatorServer interface {
	Translate(context.Context, *TranslateRequest) (*TranslationResponse, error)
...
func (UnimplementedTranslatorServer) Translate(context.Context, *TranslateRequest) (*TranslationResponse, error) {
