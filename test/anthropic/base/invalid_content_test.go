		...
		t.Run(model.Name, func(t *testing.T) {
			...
			for _, tc := range cases {
				t.Run(tc.name, func(t *testing.T) {
					body := anthropic.WithModel(tc.body, model.Name)
					wingmanResp := anthropic.PostMessages(t, h, h.Wingman, body)
					...
					anthropicBody := anthropic.WithModel(tc.body, h.ReferenceModel)
					anthropicResp := anthropic.PostMessages(t, h, h.Anthropic, anthropicBody)
