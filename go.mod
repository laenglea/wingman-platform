...
require (
	github.com/anthropics/anthropic-sdk-go v0.2.0-beta.3.0.20250517050459-6d4691c76d8b
	...
	github.com/openai/openai-go v0.1.0-beta.10.0.20250516194940-e50580de825e
